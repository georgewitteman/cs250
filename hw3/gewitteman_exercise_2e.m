...
title('Runge-Kutta 4 Simulation of Action Potential for Exercise 2e');
xlabel('time (ms)');
...
title('Runge-Kutta 4 Simulation of n, m, and h for Exercise 2e');
xlabel('time (ms)');
legend('n', 'm', 'h');
hold off;
